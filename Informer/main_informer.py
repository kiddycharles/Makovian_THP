...
parser.add_argument('--data', type=str, required=True, default='^IXIC', help='data')
parser.add_argument('--root_path', type=str, default='./equities/stocks/', help='root path of the data file')
